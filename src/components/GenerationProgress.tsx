            ...
            <div key={typeName} className="flex items-center gap-3">
              ...
              <div className="flex-shrink-0">
                {info.complete ? (
                  ...
                  <svg className="w-4 h-4 text-indigo-600 animate-spin" viewBox="0 0 24 24">
              ...
              {/* Type Name */}
              <span className={`text-sm flex-shrink-0 w-40 ${info.complete ? 'text-emerald-600' : 'text-slate-600'}`}>
                {typeName}
              </span>
              ...
              <div className="flex-1 h-2 bg-slate-100 rounded-full overflow-hidden">
                <div
                  className={`h-full transition-all duration-300 ${
                    info.complete ? 'bg-emerald-600' : 'bg-indigo-600'
                  }`}
