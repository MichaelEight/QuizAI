...
export function SaveQuizModal({
  ...
  return (
    <div className="fixed inset-0 z-50" onKeyDown={handleKeyDown}>
      ...
      {/* Modal */}
      <div className="fixed top-24 inset-x-0 bottom-0 flex items-start justify-center pointer-events-none p-4 pt-8">
        <div className="relative bg-slate-800 border border-slate-700 rounded-2xl p-6 max-w-lg w-full shadow-2xl shadow-black/50 animate-fade-in pointer-events-auto max-h-[85vh] overflow-y-auto">
        {/* Close button */}
        <button
          onClick={handleClose}
