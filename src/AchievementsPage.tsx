    ...
    <div className="animate-fade-in max-w-4xl mx-auto">
      ...
      <div className="text-center mb-6 sm:mb-8">
        <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-indigo-500/20 rounded-xl sm:rounded-2xl mb-3 sm:mb-4">
          <svg className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-400" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex items-center justify-center gap-2 mb-6 sm:mb-8">
        <button
          ...
          className={`flex-1 sm:flex-none px-4 sm:px-6 py-2.5 rounded-lg font-medium transition-all duration-200 ${
